const AddCustomer =  ({id,cust_number,posting_id,invoice_id,isOpen,is_deleted,total_open_amount,
    ...
    return<>
        <form className="myTable">
            ...
            <label>Is Open (1,0) :  </label>
            <input name="isOpen" value={isOpen}  type="number"  onChange={changeHandler}/>
            <label>is Deleted :  </label>
            <input name="is_deleted" value={is_deleted}  type="number" onChange={changeHandler}/>
            <br/>
